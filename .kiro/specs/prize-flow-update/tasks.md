...
- [ ] 1. Database migration и модели
  - [ ] 1.1 Добавить поле gdpr_consent_date в модель Prize
  ...
  - [ ] 1.2 Создать SQL миграцию для добавления поля
  ...
  - [ ] 1.3 Расширить PrizeRepository новыми методами
  ...
  - [ ] 1.4 Написать unit тесты для PrizeRepository
...
- [ ] 2. FSM States и клавиатуры
  - [ ] 2.1 Создать PrizeFlowStates в fsm/states.py
  ...
  - [ ] 2.2 Создать модуль keyboards/reply_keyboards.py
  ...
  - [ ] 2.3 Написать unit тесты для клавиатур
...
- [ ] 4. Расширение PrizeService
  - [ ] 4.1 Добавить метод check_user_exists в PrizeService
  ...
  - [ ] 4.2 Добавить метод check_gdpr_consent в PrizeService
    - Реализовать проверку наличия GDPR согласия через PrizeRepository
    - Добавить обработку DatabaseUnavailableError
    - Добавить логирование результата проверки
    - _Requirements: 3.1, 12.1_

  - [ ] 4.3 Добавить метод save_gdpr_consent в PrizeService
  ...
  - [ ] 4.4 Добавить метод validate_code_word в PrizeService
  ...
  - [ ] 4.5 Написать unit тесты для PrizeService
    - Тест для check_user_exists с существующим и несуществующим пользователем
  ...
  - [ ] 4.6 Написать property тест для GDPR consent persistence
...
- [ ] 5. Реализация PrizeFlowHandler
  - [ ] 5.1 Создать класс PrizeFlowHandler в handlers/prize_flow_handler.py
  ...
  - [ ] 5.2 Реализовать метод start_prize_flow
  ...
  - [ ] 5.3 Реализовать метод handle_consent_response
  ...
  - [ ] 5.4 Реализовать метод handle_code_word_input
  ...
  - [ ] 5.5 Реализовать метод _send_digital_prize
  ...
  - [ ] 5.6 Реализовать метод _send_physical_prize_form
  ...
  - [ ] 5.7 Написать unit тесты для PrizeFlowHandler
  ...
  - [ ] 5.8 Написать property тест для user not found response
  ...
  - [ ] 5.9 Написать property тест для unlimited code word attempts
...
- [ ] 6. Checkpoint - Проверка Prize Flow Handler
  - Убедиться, что все методы PrizeFlowHandler работают корректно
  - Убедиться, что все тесты проходят
  - Спросить пользователя, если возникли вопросы

- [ ] 7. Обновление CommonHandler
  - [ ] 7.1 Обновить метод handle_start в CommonHandler
  ...
  - [ ] 7.2 Написать unit тест для обновлённого handle_start
  ...
  - [ ] 7.3 Написать property тест для main menu text constraint
    - **Property 23: Main Menu Text Constraint**
    - **Validates: Requirements 1.4**
    - Проверить, что текст главного меню не содержит слово "бот"

- [ ] 8. Обновление DeliveryHandler
  - [ ] 8.1 Обновить метод handle_delivery_data в DeliveryHandler
  ...
  - [ ] 8.2 Написать unit тест для обновлённого handle_delivery_data
...
- [ ] 9. Интеграция в main.py
  ...
  - [ ] 9.2 Настроить роутинг для кнопок и состояний
  ...
  - [ ] 9.3 Написать интеграционные тесты для Prize Flow
  ...
  - [ ] 9.4 Написать property тест для FSM state reset on completion
  ...
  - [ ] 9.5 Написать property тест для main menu display on completion
...
- [ ] 11. Обработка ошибок и логирование
  - [ ] 11.1 Добавить обработку DatabaseUnavailableError во всех handlers
  ...
  - [ ] 11.2 Добавить обработку MissingPromoCodeError
  ...
  - [ ] 11.3 Добавить валидацию входных данных в FSM состояниях
  ...
  - [ ] 11.4 Добавить логирование всех ключевых операций
  ...
  - [ ] 11.5 Написать unit тесты для обработки ошибок
...
- [ ] 12. Security и валидация
  - [ ] 12.1 Добавить валидацию prize_id из WebApp
  ...
  - [ ] 12.2 Добавить проверку доступа к промокодам
  ...
  - [ ] 12.3 Написать unit тесты для security проверок
