...
- Сохранение сообщений пользователя в БД (включая системные команды)
...
# Системные команды (для справки, могут использоваться в других частях системы)
...
class MessageInterceptor:
    ...
    Логика работы:
    1. Перехватывает все входящие сообщения (включая системные команды)
