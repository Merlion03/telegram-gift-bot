...
### 003_add_chat_sessions.sql
Добавление поддержки автоматического сохранения всех диалогов:
- Добавление поля `session_type` в таблицу `support_sessions` ('chat' или 'support')
- Расширение constraint для `message_type` (добавлен тип 'from_bot')
- Дополнительные индексы для оптимизации запросов по типу сессии
